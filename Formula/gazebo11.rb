class Gazebo11 < Formula
  ...
  url "https://osrf-distributions.s3.amazonaws.com/gazebo/releases/gazebo-11.0.0.tar.bz2"
  ...
  bottle do
    ...
    sha256 "01915c780df1316a06a6555a9ec1a165ead09ee76f82e7e379398c8b2314524a" => :mojave
  end
