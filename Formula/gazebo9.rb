class Gazebo9 < Formula
  ...
  bottle do
    ...
    sha256 "5f6a48c554ce39668a2869b4b03b7e1e80094592bca45787106f2ae5a4cf32e3" => :mojave
    sha256 "cffd7d2eec724b5ec4101b10fc5ca7f650e460648a370d48c530650ae8b5af78" => :high_sierra
  end
