class Ogre19 < Formula
  ...
  if Hardware::CPU.intel?
    ...
    # full fix for Apple Mac M1 chip
    patch do
      url "https://raw.githubusercontent.com/zarathustr/sinbad-ogre/master/mac-m1-full.patch"
      sha256 "a842b9507dc4e539ec6257c045897a68da311b960585b221a899d63ec672efe3"
    end
  end
