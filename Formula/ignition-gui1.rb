class IgnitionGui1 < Formula
  ...
  bottle do
    ...
    sha256 "fff316063745820489722afb406f82cfdf4d42a3d609322d9a35cfc7eeda0116" => :mojave
    sha256 "2db3352dc3445687e06479f332946dedfffafabbe2b5f20f2b8d797ef0608251" => :high_sierra
  end
