class Gazebo5 < Formula
  ...
  patch do
    ...
    url "https://bitbucket.org/osrf/gazebo/commits/4eec0dcdb821385ffbaa62a7f0e2bd8cec21fff4/raw"
    sha256 "fc2b191453352b95c246a46303b8deb31703131dc2be300a3104512392a45a4e"
  end
